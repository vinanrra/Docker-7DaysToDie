...
# Apply permissions
RUN chown -R sdtdserver:sdtdserver /home/sdtdserver && chmod +x install.sh user.sh && find /home/sdtdserver/scripts/ -type f -exec chmod 744 {} \; && chmod 644 /home/sdtdserver/scripts/{Mods,crontab}
